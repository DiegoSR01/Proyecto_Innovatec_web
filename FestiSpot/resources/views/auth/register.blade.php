...
<div class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#181c2f] to-[#23243a] py-8">
    <div class="w-full max-w-xl bg-[#23243a] rounded-3xl shadow-2xl p-8 border border-[#2e2f4a]">
        ...
        <form method="GET" action="/dashboard" class="space-y-5">
            <div>
                <label class="block text-textMuted font-semibold mb-1">Tipo de cuenta</label>
                <div class="flex gap-4 mb-2">
                    <button type="button" class="flex-1 flex flex-col items-center justify-center gap-1 px-4 py-3 rounded-xl border-2 border-pink-500 bg-pink-500/10 text-pink-400 font-bold shadow hover:bg-pink-500/20 transition-all">
                        <i class="fa-solid fa-user text-2xl"></i>
                        Asistente
                        <span class="text-xs font-normal text-textMuted">Descubre eventos</span>
                    </button>
                    <button type="button" class="flex-1 flex flex-col items-center justify-center gap-1 px-4 py-3 rounded-xl border-2 border-fuchsia-500 bg-fuchsia-500/10 text-fuchsia-400 font-bold shadow hover:bg-fuchsia-500/20 transition-all">
                        <i class="fa-solid fa-building text-2xl"></i>
                        Productor
                        <span class="text-xs font-normal text-textMuted">Organiza eventos</span>
                    </button>
                </div>
            </div>
