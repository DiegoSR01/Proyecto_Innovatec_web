            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="mb-8 text-center">
                    ...
                    <p class="text-textMuted text-lg leading-relaxed max-w-3xl mx-auto">
                        🤝 Gestiona y revisa las propuestas de colaboración. Conecta con los mejores productores para potenciar tus eventos.
                    </p>
                </div>

                <!-- Filtros -->
                <div class="mb-8">
                    <form class="flex flex-wrap gap-4 bg-gradient-to-br from-cardLight/80 to-card/60 p-6 rounded-2xl shadow border border-cardLight/30 backdrop-blur-lg">
                        <input type="text" placeholder="Buscar productor, producto..." class="bg-card px-4 py-2 rounded-lg text-text border border-cardLight/30 focus:border-accent focus:ring-2 focus:ring-accent/20 flex-1 min-w-64" />
                ...
                <div id="solicitudes-lista" class="space-y-6">
                    <!-- Solicitud 1 -->
                    <div class="solicitud bg-gradient-to-br from-card/80 to-cardLight/60 rounded-2xl shadow-lg border border-cardLight/30 flex flex-col md:flex-row items-center gap-6 p-6 backdrop-blur-lg"
